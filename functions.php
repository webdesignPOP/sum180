 ...
 if(is_user_logged_in())
    {
        ...
        $name = $udata->first_name; // or user_login , user_firstname, user_lastname
		$items .= '<li id = "custom_menu_user1" ><a href="http://sum180.com/Private/Account.aspx">Hi, '.$name.'</a> | </li>';
        $items .= '<li id = "custom_menu_user2" ><a href="https://sum180.com/public/CommunityLogin/login.aspx?out=true">Logout</a></li>'; 
